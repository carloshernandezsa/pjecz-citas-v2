...
from citas_v2.extensions import db, pwd_context

from citas_v2.blueprints.permisos.models import Permiso
from citas_v2.blueprints.tareas.models import Tarea
...
class Usuario(db.Model, UserMixin, UniversalMixin):
    ...
    def launch_task(self, nombre, descripcion, *args, **kwargs):
        """Arrancar tarea"""
        rq_job = current_app.task_queue.enqueue("citas_v2.blueprints." + nombre, *args, **kwargs)
